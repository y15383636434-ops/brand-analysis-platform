...
def update_crawl_task_table():
    ...
    try:
        with engine.connect() as conn:
            ...
            # Try to add columns directly, catching error if they exist
            try:
                ...
                conn.commit()
                print("Column crawl_type added.")
            except Exception as e:
                if "Duplicate column name" in str(e):
                    print("Column crawl_type already exists.")
                else:
                    print(f"Error adding crawl_type: {e}")
            ...
            try:
                ...
                conn.commit()
                print("Column target_url added.")
            except Exception as e:
                if "Duplicate column name" in str(e):
                    print("Column target_url already exists.")
                else:
                    print(f"Error adding target_url: {e}")
