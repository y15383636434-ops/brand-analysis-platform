...
# 命令参数
cmd = ['C:\\Users\\Yu\\cursorProjects\\githup\\MediaCrawler\\python_env\\python.exe', 'C:\\Users\\Yu\\cursorProjects\\githup\\MediaCrawler\\main.py', '--platform', 'dy', '--lt', 'cookie', '--type', 'creator', '--save_data_option', 'json', '--keywords', 'MS4wLjABAAAAEFr-j40Q', '--get_comment', 'yes', '--get_sub_comment', 'no']
