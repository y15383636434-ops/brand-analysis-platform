...
类型: creator
关键词: N/A
目标URL: https://www.douyin.com/user/MS4wLjABAAAAczcZgfDJtJ-MwClXIjPH_QRcUphk41pMDw6OpNnsRz1p4NYa9rzwQKORjWdCDUAc?from_tab_name=main&vid=7595445472047746338
最大数量: 3
生成时间: 2026-01-16 13:03:45
"""
# -*- coding: utf-8 -*-
import subprocess
import sys
...
# 命令参数
cmd = ['C:\\Users\\Yu\\cursorProjects\\githup\\MediaCrawler\\python_env\\python.exe', 'C:\\Users\\Yu\\cursorProjects\\githup\\MediaCrawler\\main.py', '--platform', 'dy', '--lt', 'cookie', '--type', 'creator', '--save_data_option', 'json', '--keywords', 'MS4wLjABAAAAczcZgfDJ', '--get_comment', 'no', '--get_sub_comment', 'no']
...
print(f"开始爬取: douyin")
print(f"类型: creator")
print(f"目标URL: https://www.douyin.com/user/MS4wLjABAAAAczcZgfDJtJ-MwClXIjPH_QRcUphk41pMDw6OpNnsRz1p4NYa9rzwQKORjWdCDUAc?from_tab_name=main&vid=7595445472047746338")
print(f"最大数量: 3")
print("=" * 70)
...
try:
    if config_file_path.exists():
        ...
        # 替换变量值
        target_urls = ['https://www.douyin.com/user/MS4wLjABAAAAczcZgfDJtJ-MwClXIjPH_QRcUphk41pMDw6OpNnsRz1p4NYa9rzwQKORjWdCDUAc?from_tab_name=main&vid=7595445472047746338']
