...
类型: creator
关键词: N/A
目标URL: https://www.douyin.com/user/MS4wLjABAAAAbVEMVULOU5JKu5uQlReIoAWzKrjamvRObPjfWsJfl3E?from_tab_name=main&vid=7593658222062457926
最大数量: 5
生成时间: 2026-01-16 10:00:43
"""
# -*- coding: utf-8 -*-
import subprocess
import sys
...
# 命令参数
cmd = ['C:\\Users\\Yu\\cursorProjects\\githup\\MediaCrawler\\python_env\\python.exe', 'C:\\Users\\Yu\\cursorProjects\\githup\\MediaCrawler\\main.py', '--platform', 'dy', '--lt', 'cookie', '--type', 'creator', '--save_data_option', 'json', '--keywords', 'MS4wLjABAAAAbVEMVULO', '--get_comment', 'yes', '--get_sub_comment', 'no']
...
print(f"开始爬取: douyin")
print(f"类型: creator")
print(f"目标URL: https://www.douyin.com/user/MS4wLjABAAAAbVEMVULOU5JKu5uQlReIoAWzKrjamvRObPjfWsJfl3E?from_tab_name=main&vid=7593658222062457926")
print(f"最大数量: 5")
print("=" * 70)
...
try:
    if config_file_path.exists():
        ...
        # 替换变量值
        target_urls = ['https://www.douyin.com/user/MS4wLjABAAAAbVEMVULOU5JKu5uQlReIoAWzKrjamvRObPjfWsJfl3E?from_tab_name=main&vid=7593658222062457926']
